                            ...
                            <div class="container px-5 py-24 mx-auto">
                                ...
                                <div class="flex flex-wrap -m-2">
                                    ...
                                    <div class="relative">
                                        ...
                                        <select name="age">
                                            <option value="" @if($contact->age == "" ) selected @endif>chose</option>
                                    ...
                                    <div class="p-2 w-full">
                                    <button class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Complete</button>
                                    </div>
                                </div>
                                </div>
                            </div>
